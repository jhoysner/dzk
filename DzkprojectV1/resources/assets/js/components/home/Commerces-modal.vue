<template>
  <div>
        <b-modal id="commercesModal" ref="commercesModal" hide-header hide-footer>
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <h2>Hola</h2>
                    <h4>En que Tienda quieres pedir?</h4>
                  </div>
                  <div class="col-lg-12">
                    <select v-model="idcommerce" class="form-control common-input" @change="view(idcommerce)">
                      <option v-for="opt in commerces" :value="opt.idcommerce">{{opt.name}}</option>
                    </select>
                  </div>
                  <div class="col-lg-12" v-if="branch">
                    <h4>Y sucursal?</h4>
                  ...
                  <div class="col-lg-12 text-right" v-if="branch">
                    <button class="btn primary-btn" @click="selectCommerceBranch(idcommerce,idbranch)">Aceptar</button>
                  </div>
                </div>             
              </div>
          </div>
