                ...
                <div class="col-lg-12 stat-wrap-container">
                    <div class="stat-wrap my-4">
                            ...
                            <div class="col-lg-12">
                              <div class="form-group">
                                ...
                                <select name="" class="form-control" v-model="category">
                                  <option v-for="category in categorycommerce" :value="category.idcommercecategory">{{category.name}}</option>
                                </select>
                              </div>
                              <div class="form-group">
                        ...
                        <div class="row pb-120 pt-80">    <!-- Aqui empieza -->           
                          <div class="col-lg-3 col-md-6" v-for="commerce in commerces" :key="commerce.idcommerce">
    ...
    methods: {
      ...
      getCommerceCategories() {
        axios.get('api/commerce-categories').then(data => {
          this.categorycommerce = data.data.data;
          this.categorycommerce.unshift({idcommercecategory: null, name: 'Seleccione una opcion'});
          this.category = data.data.data[0].idcommercecategory;
        })
        .catch(err => console.log(err))
      },
